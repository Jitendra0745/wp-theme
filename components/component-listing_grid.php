...
$order_by_get = isset($_GET['order_by']) ? $_GET['order_by'] : 'DESC';
...
if (!empty($resource_types_get)) {
  $tax_query[] = [
    ...
    if (get_sub_field('pre_filter_by_resource_types')) {
      $tax_query[] = [
        'taxonomy' => 'resource_type',
        'terms'    => get_sub_field('pre_filter_by_resource_types'),
        'field' => 'term_id',
        'operator' => 'IN',
...
if (!empty($post_tag_get)) {
  $tax_query[] = [
    ...
    if (get_sub_field('pre_filter_by_tags')) {
      $tax_query[] = [
        'taxonomy' => 'post_type_tag',
        'terms'    => get_sub_field('pre_filter_by_tags'),
        'field' => 'term_id',
        'operator' => 'IN',
                ...
                <div class="rc-card-desc">
                  ...
                  <div class="rc-bottom">
                    <?php if(get_field('date')) { ?>
                      <span class="rc-date"><?php the_field('date'); ?></span>
                    <?php  } ?>
                  </div>
                </div>
              </div>
